...
//             {title}
//           </span>
//           <span className=" text-[#cbd0d1]" onClick={() => onToggle(index)}>
//             {isOpen ? <Minus /> : <Plus />}
//           </span>
//         </div>
//         {isOpen && (
//           <div className="bg-transparent py-2" onClick={() => onToggle(index)}>
//             <p
//               onClick={() => onToggle(index)}
//               className="  font-ff-inter text-[12px] md:text-base text-[#FFF] md:leading-[25.6px] font-medium opacity-[80%] bg-transparent max-w-[880px]"
//             >
//               {content}
//             </p>
//           </div>
