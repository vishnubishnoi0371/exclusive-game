      ...
      >
        <div className="max-w-[1164px] px-3 mx-auto ">
          <div className="flex flex-row flex-wrap -mx-3 pb-[75px]">
            ...
            >
              <h2 className="md:text-[48px] text-[30px] font-normal font-ff-anton md:leading-[57.5px] text-[#fff] xl:mt-[30px] mb-3 lg:mb-[16px]">
                Potenciando sus elecciones
              </h2>
              <p className="font-medium text-base font-ff-inter md:leading-[25.6px] text-[#fff] mb-3 lg:mb-[24px]">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-base font-medium font-ff-inter md:leading-[25.5px] text-[#fff] mb-2 lg:mb-3">
                  Tecnología HTML5
                </p>
              </div>
              <div className="flex items-center gap-2">
              ...
              <p className="text-base font-medium font-ff-inter md:leading-[25.5px] text-[#fff] mt-2 lg:mt-3 mb-2 lg:mb-3">
            ...
            <div className="max-w-full w-[1043px]  border-[.5px]  border-white rounded-[16px] bg_jackpot_2  xl:my-[75px]">
              <div className="flex items-center justify-center py-10 md:py-[96px]">
                ...
                <h2
                  data-aos="zoom-in"
                  data-aos-duration="2000"
                  className="text-[48px] font-ff-anton font-normal md:leading-[57px] text-center max-w-[520px] text-white"
                >
          ...
          <div className="flex items-center justify-center pt-6 lg:pt-[75px] ">
            <h2
              data-aos="zoom-in"
              data-aos-duration="2000"
              className="text-[48px] font-normal font-ff-anton text-white md:leading-[57.6px] mb-7 lg:mb-[60px]"
            >
              Juegos en vivo
            </h2>
          </div>
